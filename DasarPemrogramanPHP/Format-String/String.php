...
VAR_DUMP (chr("856"));
var_dump (str_repeat("Farhan ", 5)); // Mengulang String
var_dump (str_replace("Farhan", "Muhammad Farhan", "Farhan Wirdiansyah")); // Mengganti String

var_dump( strtr("Farhan", "F", "M")); // Mengganti Karakter